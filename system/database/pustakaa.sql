...
CREATE TABLE `buku` (
  ...
  `isbn` varchar(64) CHARACTER SET latin2 COLLATE latin2_croatian_ci NOT NULL,
...
(10, 'Detektitif Conan Ep 200', 9, 'Okigawa Sasuke', 'Cultura', 2016, '874387583987', 5, 0, 0, 'img1557401465.jpg'),
